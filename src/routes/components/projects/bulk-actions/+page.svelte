...
<svelte:head><title>BulkActions | s-m-r-t</title></svelte:head>

<article class="prose">
	<h1>BulkActions</h1>
	<p class="lead">Batch operations toolbar for selected time entries.</p>
	<h2>Installation</h2>
	<CodeBlock code={`import { BulkActions } from '@happyvertical/smrt-svelte';`} language="typescript" />
	<h2>Usage</h2>
	<CodeBlock code={`<BulkActions selectedIds={selected} actions={['delete', 'export', 'invoice']} />`} language="svelte" />
</article>
