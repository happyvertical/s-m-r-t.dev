...
<article class="prose">
	...
	<h2>Installation</h2>
	<CodeBlock code={`import { RejectDialog } from '@happyvertical/smrt-svelte';`} language="typescript" />
	<h2>Usage</h2>
	<CodeBlock code={`<RejectDialog open={showDialog} entryIds={selected} onsubmit={handleReject} />`} language="svelte" />
</article>
