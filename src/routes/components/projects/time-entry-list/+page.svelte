<script lang="ts">
	import { TimeEntryList } from '@happyvertical/smrt-svelte';
...
<article class="prose">
	...
	<h2>Installation</h2>
	<CodeBlock code={`import { TimeEntryList } from '@happyvertical/smrt-svelte';`} language="typescript" />
	<h2>Usage</h2>
	<CodeBlock code={`<TimeEntryList entries={entries} bind:selected={selectedIds} />`} language="svelte" />
</article>
