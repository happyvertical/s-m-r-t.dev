<script lang="ts">
	import { ApprovalActions } from '@happyvertical/smrt-svelte';
...
<article class="prose">
	...
	<p class="lead">Approve or reject time entries with bulk action support.</p>
	<h2>Installation</h2>
	<CodeBlock code={`import { ApprovalActions } from '@happyvertical/smrt-svelte';`} language="typescript" />
	<h2>Usage</h2>
	<CodeBlock code={`<ApprovalActions selectedIds={selected} onapprove={approve} onreject={reject} />`} language="svelte" />
</article>
