...
<article class="prose">
	...
	<h2>Installation</h2>
	<CodeBlock code={`import { UnbilledItems } from '@happyvertical/smrt-svelte';`} language="typescript" />
	<h2>Usage</h2>
	<CodeBlock code={`<UnbilledItems items={unbilledItems} onselect={createInvoice} />`} language="svelte" />
</article>
