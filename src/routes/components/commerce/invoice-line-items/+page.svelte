...
<article class="prose">
	...
	<p class="lead">Editable table of invoice line items with quantity, price, and total calculations.</p>
	<h2>Installation</h2>
	<CodeBlock code={`import { InvoiceLineItems } from '@happyvertical/smrt-svelte';`} language="typescript" />
	<h2>Usage</h2>
	<CodeBlock code={`<InvoiceLineItems bind:items={invoice.lineItems} editable={true} />`} language="svelte" />
</article>
