...
<svelte:head>
  ...
  <meta name="description" content="Get started with SMRT - a full-stack TypeScript framework for building scalable applications with auto-generated APIs." />
</svelte:head>
...
<div class="max-w-4xl mx-auto px-4 py-8">
  ...
  <section class="mb-12">
    ...
    <p class="mb-4">
      ...
      REST APIs, MCP tools, and CLI commands through simple object definitions. Define your data models once,
      and SMRT automatically generates everything you need.
    </p>
