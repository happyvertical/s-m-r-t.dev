...
<Grid>
  ...
  <section>
    ...
    <div class="faq-item">
      ...
      <p>
        <a href="https://www.youtube.com/watch?v=ls5BFzuxGw4" target="_blank" rel="noopener noreferrer">https://www.youtube.com/watch?v=ls5BFzuxGw4</a>
      </p>
    </div>
...
class Product extends SmrtObject {
  // ...
    ...
    <div class="faq-item">
      ...
      <p>
        Use the <a href="/modules/smrt-tenancy">smrt-tenancy</a> module
...
describe('Task Tests', () => {
  it('should create task', async () => {
    ...
    <div class="faq-item">
      ...
      <p>
        Yes! s-m-r-t works great with SvelteKit. Use the <a href="/modules/template-sveltekit">template-sveltekit</a> template
    ...
    <div class="faq-item">
      ...
      <p>
        s-m-r-t includes built-in MCP (Model Context Protocol) support. Enable it with <code>mcp: true</code>
...
class Order extends SmrtObject {
  ...
  <section>
    ...
    <div class="faq-item">
      ...
      <p>
        Ensure all s-m-r-t packages are installed and have matching versions. Run <code>npm install</code>
  ...
  <section class="last">
    ...
    <ul class="help-links">
      ...
      <li>
        <a href="https://github.com/happyvertical/smrt/issues" target="_blank" rel="noopener">→ Report an issue on GitHub</a>
      </li>
      <li>
        <a href="https://github.com/happyvertical/smrt/discussions" target="_blank" rel="noopener">→ Ask a question in Discussions</a>
      </li>
    </ul>
  </section>
</Grid>
